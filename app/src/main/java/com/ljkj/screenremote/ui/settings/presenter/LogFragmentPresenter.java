 ...
 * 描述:
 */
public class LogFragmentPresenter extends BaseRxPresenter<LogFragmentContract.LogFragmentView> implements LogFragmentContract.LogPresenter {
    ...
    @Override
    public void attachView(LogFragmentContract.LogFragmentView view) {
