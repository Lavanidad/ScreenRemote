 ...
 * 描述:
 */
public class IntroduceFragment extends BaseFragment<IntroducePresenter, FragmentIntroduceBinding> implements IntroduceFragmentContract.IntroduceFragmentView {
